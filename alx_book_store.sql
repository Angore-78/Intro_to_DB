...
customer_name VARCHAR(215),email VARCHAR(215),TEXT(address)) CREATE TABLE Orders(PRIMARY KEY(order_id),FOREIGN KEY(customer_id),DATE(order_date)) CREATE TABLE Order_Details(
