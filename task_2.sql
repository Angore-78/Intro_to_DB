...
customer_name VARCHAR(215),email VARCHAR(215),address TEXT) CREATE TABLE Orders(PRIMARY KEY(order_id INT),FOREIGN KEY(customer_id INT) REFERENCES Customers(Customer_id),DATE(order_date)) CREATE TABLE Order_Details(
